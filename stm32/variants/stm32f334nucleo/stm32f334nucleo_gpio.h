...
#ifdef ENABLE_HRTIM1_PINS
 DEFINE_GPIO_PIN_INIT(A,  8, ALTERNATE, PUSH_PULL, HIGH, NO_PULL, 13);
#else
 DEFINE_GPIO_PIN_INIT(A,  8, INPUT, PUSH_PULL, HIGH, NO_PULL, 13);
#endif
DEFINE_GPIO_PIN_INIT(A,  9, INPUT, PUSH_PULL, HIGH, NO_PULL, 0);
#ifdef ENABLE_HRTIM1_PINS
 DEFINE_GPIO_PIN_INIT(A,  10, ALTERNATE, PUSH_PULL, HIGH, NO_PULL, 13);
#else
 DEFINE_GPIO_PIN_INIT(A,  10, INPUT, PUSH_PULL, HIGH, NO_PULL, 13);
#endif
...
#ifdef ENABLE_HRTIM1_PINS
 DEFINE_GPIO_PIN_INIT(B, 12, ALTERNATE, PUSH_PULL, HIGH, NO_PULL, 13);
#else
 DEFINE_GPIO_PIN_INIT(B, 12, INPUT, PUSH_PULL, HIGH, NO_PULL, 13);
#endif
DEFINE_GPIO_PIN_INIT(B, 13, INPUT, PUSH_PULL, HIGH, NO_PULL, 0);
#ifdef ENABLE_HRTIM1_PINS
 DEFINE_GPIO_PIN_INIT(B, 14, ALTERNATE, PUSH_PULL, HIGH, NO_PULL, 13);
#else
 DEFINE_GPIO_PIN_INIT(B, 14, INPUT, PUSH_PULL, HIGH, NO_PULL, 13);
#endif
...
#ifdef ENABLE_HRTIM1_PINS
 DEFINE_GPIO_PIN_INIT(C,  8, ALTERNATE, PUSH_PULL, HIGH, NO_PULL, 3);
#else
 DEFINE_GPIO_PIN_INIT(C,  8, INPUT, PUSH_PULL, HIGH, NO_PULL, 3);
#endif
...
static const struct GPIO GPIOPIN[] = {
    ...
    DEFINE_GPIO_PIN(A, 10),   /*  2 PA10 D2 HRTIM_CHB1 */
    ...
    DEFINE_GPIO_PIN(A,  8),   /*  7 PA8  D7 HRTIM_CHA1 */
...
#endif
    DEFINE_GPIO_PIN(C, 10),   /* 22 PC10     PoElli ENCX24J600 CS */
    DEFINE_GPIO_PIN(D,  2),   /* 23 PD2      PoElli ENCX24J600 INT */
    DEFINE_GPIO_PIN(B, 12),   /* 24 PB12     HRTIM_CHC1 */
    DEFINE_GPIO_PIN(B, 14),   /* 25 PB14     HRTIM_CHD1 */
    DEFINE_GPIO_PIN(C,  8),   /* 26 PC8      HRTIM_CHE1 */
